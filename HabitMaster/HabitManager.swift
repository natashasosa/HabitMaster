...
class HabitManager: ObservableObject {
    ...
    Habit(title: "Study french", description: "Do grammar and vocabulary exercises or watching content in french everyday", completionGoal: 30)
    ]
}
